#!/bin/bash
set -ex
python /scratch/ashah/TCRP_Reusability_Report/code/tcrp_model/pipelines/generate_fewshot_samples.py --dataset GDSC1_PDTC --tissue PDTC --drug FK866 --K 10 --num_trials 20 --run_name 210803_drug-baseline-models
...
python /scratch/ashah/TCRP_Reusability_Report/code/tcrp_model/pipelines/generate_fewshot_samples.py --dataset GDSC1_PDTC --tissue PDTC --drug Axitinib --K 10 --num_trials 20 --run_name 210803_drug-baseline-models
